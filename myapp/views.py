...
from myapp.forms import BloodRequestSessionForm
from myapp.models import UserDetail, BloodGroup, BloodRequestSession,BloodRequestStatus 
...
def request_blood(request):
    if request.method == "POST":
        ...
        form =BloodRequestSessionForm(request.POST)
        ...
        form = BloodRequestSessionForm(initial={'req_user': request.user.id})
